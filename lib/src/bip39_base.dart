...
const _INVALID_WORDLIST = 'Invalid wordlist';
...
List<String> getWordList({String language = _defaultLanguage}) {
  if (WORDLIST.containsKey(language)) {
    return WORDLIST[language]!;
  } else {
    throw new ArgumentError(_INVALID_WORDLIST);
  }
}
